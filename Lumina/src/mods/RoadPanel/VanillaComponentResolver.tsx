...
import { InputAction, Tooltip } from "cs2/ui";
...
public get ColorField(): (props: any) => JSX.Element {
  console.log("[Resolver] ColorField requested, available keys:", Object.keys(this.cachedData));
