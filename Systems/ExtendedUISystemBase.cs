...
namespace Lumina.Systems
{
    public abstract partial class ExtendedUISystemBase : UISystemBase
    {
        ...
        {
            var helper = new ValueBindingHelper<T>(new(Mod.MODUI, key, initialValue, new GenericUIWriter<T>()));
        ...
        {
            var helper = new ValueBindingHelper<T>(new(Mod.MODUI, key, initialValue, new GenericUIWriter<T>()), updateCallBack);
            var trigger = new TriggerBinding<T>(Mod.MODUI, setterKey, helper.UpdateCallback, GenericUIReader<T>.Create());
        ...
        {
            var binding = new GetterValueBinding<T>(Mod.MODUI, key, getterFunc, new GenericUIWriter<T>());
        ...
        {
            var binding = new TriggerBinding(Mod.MODUI, key, action);
        ...
        {
            var binding = new TriggerBinding<T1>(Mod.MODUI, key, action, GenericUIReader<T1>.Create());
        ...
        {
            var binding = new TriggerBinding<T1, T2>(Mod.MODUI, key, action, GenericUIReader<T1>.Create(), GenericUIReader<T2>.Create());
        ...
        {
            var binding = new TriggerBinding<T1, T2, T3>(Mod.MODUI, key, action, GenericUIReader<T1>.Create(), GenericUIReader<T2>.Create(), GenericUIReader<T3>.Create());
        ...
        {
            var binding = new TriggerBinding<T1, T2, T3, T4>(Mod.MODUI, key, action, GenericUIReader<T1>.Create(), GenericUIReader<T2>.Create(), GenericUIReader<T3>.Create(), GenericUIReader<T4>.Create());
