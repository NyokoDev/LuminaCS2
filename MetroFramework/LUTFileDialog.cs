...
public static class ModernFileDialog
{
    ...
    public static string ShowDialog(string title = "Select a file", string filterName = "LUT Cube Files", string filterSpec = "*.cube")
    {
        ...
        try
        {
            string defaultPath = GlobalPaths.LuminaLUTSDirectory; // Must be a valid directory path
